...
# Time complexity
# As we iterate through both lists once, the time complexity of the above
# is O(N+M), where 'N' and 'M' are the total number of Intervals
...
def merge(intervals_a, intervals_b):
    ...
    while i < len(intervals_a) and j < len(intervals_b):
        ...
        # within the other intervals_a[i]
        ...
        # move next from interval which is the finishing first
